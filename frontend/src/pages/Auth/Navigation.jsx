...
const Navigation = () => {
  ...
  className="flex items-center space-x-2 transition-transform transform hover:translate-x-2 mt-8 pt-5"
>
  {isFullscreen ? (
  ...
  <span className="nav-item-name">{isFullscreen ? "Exit Fullscreen" : "Fullscreen"}</span>
</button>
